...
const KEYWORDS = [
  ...
  ['pantry & canned', ['rice', 'pasta', 'noodle', 'rotini', 'fusilli', 'penne', 'rigatoni', 'macaroni', 'linguine', 'farfalle', 'orzo', 'gnocchi', 'lasagna', 'ravioli', 'tortellini', 'couscous', 'black pepper', 'white pepper', 'peppercorn', 'ground pepper', 'flour', 'sugar', 'salt', 'oil', 'olive oil', 'vinegar', 'sauce', 'ketchup', 'mustard', 'mayo', 'mayonnaise', 'soy sauce', 'broth', 'stock', 'canned', 'soup', 'cereal', 'oat', 'oatmeal', 'honey', 'syrup', 'peanut butter', 'jam', 'jelly', 'spice', 'baking', 'yeast', 'lentil', 'chickpea', 'bean', 'tomato sauce', 'salsa', 'spaghetti', 'taco', 'cumin', 'paprika', 'cinnamon', 'vanilla', 'stock cube', 'bouillon', 'coconut milk', 'tahini', 'spread', 'nutella']],
  ['snacks', ['chip', 'crisp', 'cracker', 'cookie', 'candy', 'chocolate', 'pretzel', 'popcorn', 'nut', 'almond', 'cashew', 'walnut', 'pecan', 'pistachio', 'granola bar', 'snack', 'gum', 'trail mix', 'jerky', 'fruit snack', 'biscuit']],
  ...
  ['household', ['paper towel', 'toilet paper', 'tissue', 'napkin', 'trash bag', 'garbage bag', 'foil', 'plastic wrap', 'cling film', 'parchment', 'parchment paper', 'wax paper', 'coffee filter', 'ziploc', 'detergent', 'dish soap', 'dishwasher', 'cleaner', 'bleach', 'sponge', 'laundry', 'fabric softener', 'light bulb', 'battery', 'candle', 'air freshener', 'paper plate', 'cup', 'straw', 'match']],
